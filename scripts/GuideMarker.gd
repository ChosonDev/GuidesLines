...
var marker_type = "Line"  # Type of marker (Line, Circle, future types)
...
var color = Color(0, 0.7, 1, 1)  # Line/Circle color
var mirror = false  # Mirror line at 180 degrees [Line only]
var id = -1  # Unique identifier
var show_coordinates = false  # Show grid coordinates on marker lines/circles
